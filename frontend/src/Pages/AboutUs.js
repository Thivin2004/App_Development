  ...
  return (
    <AboutUsContainer>
      ...
      <AboutUsContent>
        ...
        <AboutUsSubtitle variant="h6">Our Mission</AboutUsSubtitle>
        <AboutUsText variant="body1" paragraph>
          Welcome to FitTrack Gym, where we are dedicated to your fitness
          journey. Our mission is to provide top-notch training and support to
          help you achieve your health and wellness goals.
        </AboutUsText>
        <AboutUsSubtitle variant="h6">Our Team</AboutUsSubtitle>
        <AboutUsText variant="body1" paragraph>
          Our expert trainers are here to offer personalized guidance and
          motivation. We believe in fostering a supportive environment where
          every member feels valued and empowered.
        </AboutUsText>
        <Grid container spacing={3} justifyContent="center">
          <Grid item xs={12} sm={4}>
            <TeamMemberCard>
              ...
              <Typography variant="body2" color="textSecondary">
                John is an experienced fitness trainer with a passion for
          ...
          <Grid item xs={12} sm={4}>
            <TeamMemberCard>
              ...
              <Typography variant="body2" color="textSecondary">
                Jane is a certified nutritionist who provides personalized diet
                plans and advice.
              </Typography>
            </TeamMemberCard>
          </Grid>
        ...
        <AboutUsSubtitle variant="h6">Join Us</AboutUsSubtitle>
        <AboutUsText variant="body1">
          Discover a new level of fitness at FitTrack Gym. Join us today and
          take the first step towards a healthier, stronger you!
        </AboutUsText>
        <CallToActionButton variant="contained">Get Started</CallToActionButton>
      </AboutUsContent>
    </AboutUsContainer>
  );
};
